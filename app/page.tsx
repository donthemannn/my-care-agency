      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="mt-16 grid gap-8 max-w-5xl mx-auto md:grid-cols-3">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition duration-300 border border-gray-100">
