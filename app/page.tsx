      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="space-y-4">
            <SignedOut>
              <SignInButton mode="redirect" forceRedirectUrl="/dashboard">
                <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-10 rounded-xl text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition duration-300">
            ...
            <SignedIn>
              <div className="flex items-center justify-center space-x-4">
                <Link 
                  href="/dashboard"
                  className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-10 rounded-xl text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition duration-300"
                >
                  Go to Dashboard
                </Link>
          ...
          <div className="mt-16 grid gap-8 max-w-5xl mx-auto md:grid-cols-3">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition duration-300 border border-gray-100 motion-reduce:transform-none">
